...
fn process(input: &str, part: u8) -> u64 {
    let lines = input
        .lines()
...
7214296 k";
    ...
    #[test]
    fn test_input() {
        assert_eq!(process(TEST_INPUT, 1), 95437);
        assert_eq!(process(TEST_INPUT, 2), 24933642);
    }

    #[test]
    fn part_1() {
        assert_eq!(process(INPUT, 1), 1118405);
    }

    #[test]
    fn part_2() {
        assert_eq!(process(INPUT, 2), 12545514);
    }
}
